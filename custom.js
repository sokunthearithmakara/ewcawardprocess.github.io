$(document).ready(function() {
    ...
    $("#personal2").closest('legend').addClass("text-muted");
    $("[name='contactInfo.secondEmail']").change(function() {
        if ($(this).val() != "") {
            ...
            $("#homeSecondEmailType").closest('legend').addClass("text-muted");
        } else {
            ...
            $("#homeSecondEmailType").closest('legend').removeClass("text-muted");
        }
    });
    $("[name='emergencyContactInfo.secondaryTelephone']").change(function() {
        if ($(this).val() != "") {
            ...
            $("#personal2").closest('legend').removeClass("text-muted");
        }
    });
